...
const reactEcosystemGraph: MapDocument = {
  ...
  description: 'A small slice of the libraries people reach for around React.',
  nodes: [
    {
      id: 'react',
      label: '**React**',
    ...
    { id: 'vite', label: '`Vite`', shape: 'rounded', color: 'violet' },
    { id: 'next', label: '`Next.js`', shape: 'rounded' },
    { id: 'remix', label: '`Remix`', shape: 'rounded' },
    {
      id: 'router',
      label: '`React Router`',
      shape: 'rounded',
    ...
    { id: 'zustand', label: '`Zustand`', shape: 'rounded' },
    { id: 'redux', label: '`Redux Toolkit`', shape: 'rounded' },
    {
      id: 'tailwind',
      label: '`Tailwind`',
      shape: 'rounded',
    ...
    { id: 'radix', label: '`Radix UI`', shape: 'rounded' },
    {
      id: 'shadcn',
      label: '`shadcn/ui`',
      shape: 'rounded',
    ...
    { id: 'rtl', label: '`Testing Library`', shape: 'rounded' },
    { id: 'vitest', label: '`Vitest`', shape: 'rounded' },
  ],
  edges: [
    { from: 'vite', to: 'react', label: 'bundles' },
    { from: 'next', to: 'react', label: 'wraps' },
    { from: 'remix', to: 'react', label: 'wraps' },
    { from: 'router', to: 'remix', label: 'shared core', direction: 'both' },
    { from: 'query', to: 'react', label: 'hooks' },
    { from: 'zustand', to: 'react', label: 'state' },
    { from: 'redux', to: 'react', label: 'state' },
    { from: 'redux', to: 'zustand', label: '*alt*', style: 'dashed', direction: 'both' },
    { from: 'shadcn', to: 'radix', label: 'built on' },
    { from: 'shadcn', to: 'tailwind', label: 'styled with' },
    { from: 'rtl', to: 'react', label: 'tests' },
    { from: 'vitest', to: 'rtl', label: 'runs' },
    { from: 'vitest', to: 'vite', label: 'shares config' },
  ],
}
...
export const EXAMPLES: ExampleEntry[] = [
  ...
  },
  {
    ...
    description: 'Force-directed graph of common React libraries.',
    map: reactEcosystemGraph,
  },
  {
